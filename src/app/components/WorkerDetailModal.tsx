  ...
  return (
    <div className="fixed inset-0 z-[200] bg-black/50 backdrop-blur-sm flex items-end sm:items-center justify-center">
      <div className="w-full max-w-md bg-gray-50 rounded-t-3xl sm:rounded-2xl shadow-2xl max-h-[92vh] overflow-y-auto pb-6 text-gray-800">
        ...
        {/* Banner */}
        <div className="bg-gradient-to-r from-teal-600 to-teal-900 h-28 relative rounded-t-3xl sm:rounded-t-2xl">
          ...
          <div className="absolute -bottom-12 left-1/2 -translate-x-1/2">
            <div className="relative">
              {detail.avatar
                ...
                : <div className="w-24 h-24 rounded-full border-4 border-white shadow-lg bg-gradient-to-br from-teal-500 to-teal-800 flex items-center justify-center text-2xl font-black text-white">
        ...
        <div className="pt-14 px-6 text-center">
          ...
          <div className="flex justify-center gap-6 mt-3 pb-3 border-b border-gray-200">
            ...
            <div className="text-center">
              <p className="text-base font-bold text-amber-700">🔥 {freshScore}</p>
        ...
        <div className="px-6 py-4 space-y-5">
              ...
              {(['perfil', 'tienda'] as const).map(tab => (
                <button
                  ...
                  className={`pb-2 text-sm font-bold capitalize transition border-b-2 -mb-px ${
                    activeTab === tab ? 'border-teal-500 text-teal-800' : 'border-transparent text-gray-400 hover:text-gray-600'
                  }`}
                >
          ...
          <div className="flex gap-3 pt-2 border-t border-gray-200">
            <button onClick={() => window.open(`https://wa.me/?text=${encodeURIComponent(shareText + '\n' + shareUrl)}`, '_blank')}
              className="flex-1 flex items-center justify-center gap-2 bg-teal-50 text-teal-800 py-2.5 rounded-xl font-semibold text-sm border border-teal-200 hover:bg-teal-100 transition">
