...
#JobsHours #TrabajoLocal #${cardData.city.replace(/\s/g, '')}`
    ...
    return (
      <div className="fixed inset-0 bg-black/50 z-[300] flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl p-8 max-w-md">
          ...
          <button type="button" onClick={onClose} className={uiTone.modalSoftDismiss}>
            {surfaceCopy.close}
          </button>
        </div>
      </div>
  ...
  const statusColor = availability === 'available' ? 'bg-teal-500' : 'bg-amber-500'
          ...
          <div ref={cardRef} className="bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-yellow-400/80 transform transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_40px_100px_-15px_rgba(0,0,0,0.25)]">
            ...
            <div className="bg-gradient-to-r from-yellow-400 to-yellow-500 p-5 flex justify-between items-center shadow-md">
              ...
              <div className={`flex items-center gap-2 bg-white/60 px-4 py-2 rounded-full border border-yellow-600/30 shadow-inner`}>
                <span className={`w-3 h-3 ${statusColor} rounded-full animate-pulse ring-2 ring-teal-200`}></span>
            ...
            <div className="pt-10 px-6 pb-8 bg-gradient-to-b from-yellow-50/50 to-white text-center relative">
              <div className="relative inline-block mb-6">
                ...
                {cardData.is_verified && (
                  <div className="absolute -bottom-4 -right-4 bg-gradient-to-br from-teal-500 to-teal-600 p-3 rounded-2xl border-4 border-white shadow-xl">
              ...
              {cardData.total_jobs > 0 ? (
                ...
                <div className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-2xl p-4 border border-teal-200">
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <span className="text-sm font-black text-teal-950">Perfil verificado en JobsHours</span>
                  </div>
                </div>
              )}
            </div>
          ...
          <div className="mt-6 bg-white rounded-2xl p-4 shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500 text-white font-bold py-3 px-4 rounded-xl transition shadow-lg shadow-amber-500/25"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 bg-slate-700 hover:bg-slate-600 text-white font-bold py-3 px-4 rounded-xl transition shadow-lg"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button
                onClick={copyLink}
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-amber-600 to-orange-700 hover:from-amber-500 hover:to-orange-600 text-white font-bold py-3 px-4 rounded-xl transition shadow-lg shadow-amber-500/20"
              >
